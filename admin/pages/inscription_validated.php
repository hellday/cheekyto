                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            while ($donnees = $req->fetch())
                            {
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td class="text-center"><a href="inscription_modif.php?id=<?php echo $donnees['id']; ?>"><button type="button" class="btn btn-success btn-circle"><i class="fa fa-link"></i></button></a></td>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel">Modification validé</h4>
                                        </div>
                                        <div class="modal-body">
                                            La modification a bien été validé !
                                        </div>
