...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Inscriptions refusées</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        Inscriptions refusées (possibilité de validation)
                    </div>
                    <!-- /.panel-heading -->
                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            while ($donnees = $req->fetch())
                            {
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td class="text-center"><a href="inscription_refused.php?id=<?php echo $donnees['id']; ?>"><button type="button" class="btn btn-default btn-circle" ><i class="fa fa-check"></i></button></a></td>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            L'inscription précedemment refusé à été validé !
                                        </div>
